...
usernames_list = [
    'vasya.ivanov', 'second-user', 'third-user-username', 'NoEmail', 'NoFirstName',
    'NoLastName', 'NoPassword', 'TooLongEmail',
...
emails_list = [
    'vasya@example.com', 'second@example.com', 'third@example.com',
    'noemail@example.com', 'duplicate@example.com'
]
